#!/bin/bash
#SBATCH -o /lab/haoq_lab/cse12310520/CV-Project/CV-Project-Image-Captioning/logs/VLM_evaluate.%j.out          # 脚本执行的输出将被保存在当job.%j.out文件下，%j表示作业号;
#SBATCH --partition=a100     # 作业提交的指定分区队列为titan
#SBATCH --qos=a100         # 指定作业的QOS
#SBATCH -J VLM_evaluate       
#SBATCH --nodes=1              
